...
func request_TickerQuery_Price_0(ctx context.Context, marshaler runtime.Marshaler, client TickerQueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TokenPriceRequest
	var metadata runtime.ServerMetadata
...
func local_request_TickerQuery_Price_0(ctx context.Context, marshaler runtime.Marshaler, server TickerQueryServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TokenPriceRequest
	var metadata runtime.ServerMetadata
...
func RegisterTickerQueryHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TickerQueryServer) error {
	...
	mux.Handle("GET", pattern_TickerQuery_Price_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/ticker.TickerQuery/Price", runtime.WithHTTPPathPattern("/price/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_TickerQuery_Price_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_TickerQuery_Price_0(annotatedContext, mux, outboundMarshaler, w, req, response_TickerQuery_Price_0{resp}, mux.GetForwardResponseOptions()...)
...
func RegisterTickerQueryHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TickerQueryClient) error {
	...
	mux.Handle("GET", pattern_TickerQuery_Price_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/ticker.TickerQuery/Price", runtime.WithHTTPPathPattern("/price/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_TickerQuery_Price_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
type response_TickerQuery_Price_0 struct {
	proto.Message
}

func (m response_TickerQuery_Price_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*TokenPriceResponse)
...
var (
	...
	pattern_TickerQuery_Price_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"price", "name"}, ""))
...
var (
	...
	forward_TickerQuery_Price_0 = runtime.ForwardResponseMessage
