...
// UnimplementedTickerQueryServer must be embedded to have
...
func (UnimplementedTickerQueryServer) testEmbeddedByValue()                     {}
...
func RegisterTickerQueryServer(s grpc.ServiceRegistrar, srv TickerQueryServer) {
	// If the following call pancis, it indicates UnimplementedTickerQueryServer was
