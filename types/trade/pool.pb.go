...
var file_trade_pool_proto_rawDesc = string([]byte{
...
var (
	...
	file_trade_pool_proto_rawDescData []byte
)

func file_trade_pool_proto_rawDescGZIP() []byte {
	file_trade_pool_proto_rawDescOnce.Do(func() {
		file_trade_pool_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_trade_pool_proto_rawDesc), len(file_trade_pool_proto_rawDesc)))
	})
...
func file_trade_pool_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_trade_pool_proto_rawDesc), len(file_trade_pool_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
