...
func file_trade_pool_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_trade_pool_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Share); i {
			case 0:
				return &v.state
			case 1:
		...
		file_trade_pool_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Stake); i {
			case 0:
				return &v.state
			case 1:
		...
		file_trade_pool_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Pool); i {
			case 0:
				return &v.state
			case 1:
