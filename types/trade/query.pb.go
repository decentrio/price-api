...
var file_trade_query_proto_rawDesc = []byte{
	...
	0xf5, 0x01, 0x0a, 0x0a, 0x54, 0x72, 0x61, 0x64, 0x65, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x59,
	...
	0x70, 0x65, 0x72, 0x77, 0x65, 0x65, 0x6b, 0x42, 0x77, 0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x2e, 0x74,
...
var file_trade_query_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_trade_query_proto_goTypes = []any{
	...
	(*TradeVolumeByWeek)(nil),            // 5: trade.TradeVolumeByWeek
}
var file_trade_query_proto_depIdxs = []int32{
	4, // 0: trade.TradesResponse.trades:type_name -> trade.TradeInfo
	5, // 1: trade.TradingVolumePerWeekResponse.trading_volume:type_name -> trade.TradeVolumeByWeek
	0, // 2: trade.TradeQuery.Trades:input_type -> trade.TradesRequest
	2, // 3: trade.TradeQuery.TradingVolumePerWeek:input_type -> trade.TradingVolumePerWeekRequest
	1, // 4: trade.TradeQuery.Trades:output_type -> trade.TradesResponse
	3, // 5: trade.TradeQuery.TradingVolumePerWeek:output_type -> trade.TradingVolumePerWeekResponse
